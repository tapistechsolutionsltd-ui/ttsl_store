...
<div class="min-h-[80vh] flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2">Join TTSL Store today</p>
        </div>

        <div class="card p-8">
            @php $googleEnabled = \App\Models\Setting::get('google_login_enabled', '0') === '1'; @endphp

            {{-- Google Sign-Up (shown only when enabled) --}}
            @if($googleEnabled)
            ...
            <div class="relative flex items-center mb-5">
                ...
                <span class="px-3 text-xs text-gray-400 font-medium">or register with email</span>
                <div class="flex-1 border-t border-gray-200"></div>
            </div>
            @endif
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}"
                        class="input-field" placeholder="+675 XXX XXXX" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" class="input-field" placeholder="Repeat your password" required />
                </div>
