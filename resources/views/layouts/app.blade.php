    ...
    <nav class="hidden sm:block bg-brand border-t border-white/10">
        ...
        <div class="max-w-screen-2xl mx-auto px-3 sm:px-4 flex items-center">
            ...
            <div class="flex items-center overflow-x-auto hide-scrollbar flex-1 min-w-0">
                ...
                <a href="{{ route('cpp.index') }}"
                   class="px-3 py-2.5 text-sm hover:bg-white/15 rounded-sm whitespace-nowrap flex-shrink-0 transition-colors {{ request()->routeIs('cpp.*') ? 'font-bold bg-white/10' : '' }}">
                    Promotions
                </a>
                @auth
                    @if(auth()->user()->isAdmin())
    ...
    <div x-show="mobileOpen"
        ...
        <div class="px-4 py-3">
            ...
            <div class="space-y-0.5 mb-4">
                ...
                <a href="{{ route('cpp.index') }}"
                   class="flex items-center gap-3 py-2.5 px-3 rounded-lg text-sm hover:bg-white/10 transition-colors {{ request()->routeIs('cpp.*') ? 'bg-white/10 font-semibold' : '' }}">
                    <svg class="w-4 h-4 text-gray-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
                    </svg>
                    Promotions
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-400">
                    ...
                    <li><a href="{{ route('cpp.index') }}" class="hover:text-white transition-colors">Client Promotions Portal</a></li>
                    <li><a href="{{ route('faq') }}" class="hover:text-white transition-colors">FAQs</a></li>
