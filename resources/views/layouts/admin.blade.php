...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-brand-dark text-white flex flex-col flex-shrink-0 fixed inset-y-0 z-50 transition-transform"
        ...
        <div class="p-4 border-b border-white/10">
            <img src="{{ asset('images/ttsolutions_logo.png') }}" alt="TTSolutions Limited" class="w-auto object-contain" style="height: 46px;">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <div class="pt-3 pb-1">
                <p class="text-xs text-blue-300 uppercase tracking-wider px-4">Client Promotions</p>
            </div>
            <a href="{{ route('admin.cpp.dashboard') }}"
               class="admin-sidebar-link {{ request()->routeIs('admin.cpp.dashboard') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                </svg>
                CPP Dashboard
            </a>
            <a href="{{ route('admin.cpp.promotions.index') }}"
               class="admin-sidebar-link {{ request()->routeIs('admin.cpp.promotions.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
                </svg>
                Promotions
            </a>
            <a href="{{ route('admin.cpp.clients.index') }}"
               class="admin-sidebar-link {{ request()->routeIs('admin.cpp.clients.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                </svg>
                Clients
            </a>
            <a href="{{ route('admin.cpp.codes.index') }}"
               class="admin-sidebar-link {{ request()->routeIs('admin.cpp.codes.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/>
                </svg>
                Codes
            </a>
            <a href="{{ route('admin.cpp.reports.registrations') }}"
               class="admin-sidebar-link {{ request()->routeIs('admin.cpp.reports.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
                CPP Reports
            </a>
            <a href="{{ route('admin.cpp.settings.index') }}"
               class="admin-sidebar-link {{ request()->routeIs('admin.cpp.settings.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
