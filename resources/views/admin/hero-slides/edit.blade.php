...
<form method="POST" action="{{ route('admin.hero-slides.update', $heroSlide) }}" enctype="multipart/form-data"
    ...
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="card p-5">
            ...
            <p class="text-xs text-gray-400 mb-4">Recommended: 1920×600px or wider. Supports JPG, PNG, WebP, GIF or MP4 (max 50 MB). MP4 videos autoplay, loop and are muted.</p>
    ...
    <div class="space-y-5">
        ...
        <button type="submit" class="btn-primary w-full flex items-center justify-center gap-2" :disabled="uploading">
            ...
            <span x-text="uploading ? 'Saving…' : 'Save Changes'"></span>
        </button>
