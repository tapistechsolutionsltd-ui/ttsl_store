...
<div class="wrap">
    ...
    <div class="body">
        <h2 style="margin-top:0;color:#0a2540;">Promotion Reached Maximum Capacity</h2>
        <p>The promotion <strong>{{ $promotion->title }}</strong> has reached its maximum of
            <strong>{{ $promotion->max_clients }}</strong> registered clients and has been automatically closed to new registrations.</p>
